...
#-----------------------------------------------------------------------
PSF = os.path.abspath(os.path.normpath(os.path.join(os.getcwd(),sys.argv[2]+'/../adk4AKE.psf')))
longXTC1 = os.path.abspath(os.path.normpath(os.path.join(os.getcwd(),sys.argv[2]+'/newtraj1.xtc')))
