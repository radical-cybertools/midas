...
RESULT_FILE= "results/producer_1/kafka-throughput-producer-" + run_timestamp.strftime("%Y%m%d-%H%M%S") + ".csv"
STDOUT_FILE = "results/producer_1/stdout-" + run_timestamp.strftime("%Y%m%d-%H%M%S") + ".csv"
STDOUT_LOOP_FILE = "results/producer_1/stdout_loop-" + run_timestamp.strftime("%Y%m%d-%H%M%S") + ".csv"


try:
    os.makedirs("results/producer_1")
except:
    pass
...
stdout_file.write('Produce_batch_Start,Produce_batch_Stop,Num_Messages,Number_APoints/Msg,KB_Transfered,KB/sec\n')
